// ============================================================
// scrape_text_metrics.js - IMPROVED VERSION
// ============================================================
    ...
    try {
        ...
        for (let i = 0; i < lines.length; i++) {
            if (lines[i] === "Select Row") {
                ...
                console.log("  Block:", block.slice(0, 5).join(" | "));
        ...
        if (
            previousMetrics &&
            JSON.stringify(previousMetrics.this_week) === JSON.stringify(metrics.this_week)
        ) {
